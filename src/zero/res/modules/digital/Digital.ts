...
export class Digital extends PonModule {
    ...
    protected createdView() {
        ...
        this.clock.allListenerSet(
            true
            , (e: ClockEvent) => {
                this.$milliseconds.html("" + e.value);
            }
            , (e: ClockEvent) => {
                this.$seconds.html("" + e.value);
            }
            , (e: ClockEvent) => {
                this.$minutes.html("" + e.value);
            }
            , (e: ClockEvent) => {
                this.$hours.html("" + e.value);
            }
            , (e: ClockEvent) => {
                this.$date.html("" + e.value);
            }
            , (e: ClockEvent) => {
                this.$month.html("" + e.value);
            }
            , (e: ClockEvent) => {
                this.$fullYear.html("" + e.value);
            }
        );
    }
